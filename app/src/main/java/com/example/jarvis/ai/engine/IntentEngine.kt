...
class IntentEngine(
    ...
    private fun mapStructuredToCommand(structured: StructuredIntent): CommandIntent {
        val category = when (structured.intentId) {
            ...
            "SEND_MESSAGE_IN_APP", "COMPOSE_SMS", "DIAL_NUMBER", "OPEN_CONTACTS", "CALL_CONTACT", "SEND_WHATSAPP_MESSAGE", "SEND_TELEGRAM_MESSAGE" -> IntentCategory.COMMUNICATION
            "GET_BATTERY", "BATTERY_TEMPERATURE", "CHARGING_STATUS", "GET_RAM", "CPU_STATUS", "GET_STORAGE", "TORCH", "SET_VOLUME", "LOCK_SCREEN", "GET_WEATHER" -> IntentCategory.SYSTEM
            "READ_VISIBLE_TEXT", "SCROLL", "CLICK_UI_ELEMENT", "ANALYZE_PHOTO" -> IntentCategory.ACCESSIBILITY
            "CREATE_ALARM", "LIST_ALARMS", "DELETE_ALARM", "CREATE_REMINDER", "SET_TIMER" -> IntentCategory.ALARM_REMINDER
